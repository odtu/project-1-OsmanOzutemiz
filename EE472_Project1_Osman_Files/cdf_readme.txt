...
Columns  1- 4   Bus number (I) *0
Columns  7-17   Name (A) (left justify) *
Columns 19-20   Load flow area number (I) Don't use zero! *1
Columns 21-23   Loss zone number (I)2
Columns 25-26   Type (I) *3
                 0 - Unregulated (load, PQ)
                 1 - Hold MVAR generation within voltage limits, (PQ)			0 da 1 de ikisi de pq bara
                 2 - Hold voltage within VAR limits (gen, PV)
                 3 - Hold voltage and angle (swing, V-Theta) (must always
                      have one)
Columns 28-33   Final voltage, p.u. (F) *4
Columns 34-40   Final angle, degrees (F) *5
Columns 41-49   Load MW (F) * 6
Columns 50-59   Load MVAR (F) *7
Columns 60-67   Generation MW (F) *8
Columns 68-75   Generation MVAR (F) *9
Columns 77-83   Base KV (F)10
